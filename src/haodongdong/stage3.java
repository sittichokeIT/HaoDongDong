...
public class stage3 extends JPanel implements ActionListener{
    private ImageIcon wallpaper = new ImageIcon(this.getClass().getResource("bg3.png"));
    private ImageIcon wallpapers = new ImageIcon(this.getClass().getResource("bg33.gif"));
    private ImageIcon closebutton = new ImageIcon(this.getClass().getResource("closebt.gif"));
    private ImageIcon win = new ImageIcon(this.getClass().getResource("bg3_1.gif"));
    private Timer timer = new Timer(100, new Listener());
    private Timer timercount = new Timer(1000, new Listener());
    HaoChar hc = new HaoChar(3);
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(w1.doorwarp.getImage(), w1.x, w1.y, 28, 29, this);  
        g.drawImage(w1.doorwarp.getImage(), w1.x2, w1.y2, 28, 29, this); 
        g.drawImage(stair.stair.getImage(), stair.x, stair.y, 40, 205, this);
        ...
        if(checkbacktofront==0){           
            if(hc.count==0){
                if(checkattack == 1){
                    g.drawImage(hc.atkf.getImage(), hc.x+16, hc.y, 90, 70, this);
                    ...
                    g.drawImage(hc.im.getImage(), hc.x, hc.y, 65, 70, this);
                    g.drawString("HP : "+hc.hp, hc.x, hc.y-15);
                }            
            }
            else {
                g.drawImage(hc.imk.getImage(), hc.x, hc.y, 65, 70, this);
                g.drawString("HP : "+hc.hp,hc.x, hc.y-15);
            }
            ...
            if(hc.count==0){
                if(checkattack == 1){
                    g.drawImage(hc.atkb.getImage(), hc.x-41, hc.y, 90, 70, this);
                    g.drawString("HP : "+hc.hp, hc.x, hc.y-15);
                    ...
                    g.drawImage(hc.imb.getImage(), hc.x, hc.y, 65, 70, this);
                    g.drawString("HP : "+hc.hp, hc.x, hc.y-15);
                }         
            }
            else{
                g.drawImage(hc.imbk.getImage(), hc.x, hc.y, 65, 70, this);
                g.drawString("HP : "+hc.hp, hc.x, hc.y-15);
            }
        }
        if(MW1.alive==false){
            g.drawImage(w2.doorwarp.getImage(), w2.x, w2.y, 28, 29, this);
            g.drawImage(w2.doorwarp.getImage(), w2.x2, w2.y2, 28, 29, this); 
        }
        if(MW2.alive==false){
            g.drawImage(w3.doorwarp.getImage(), w3.x, w3.y, 28, 29, this);
            g.drawImage(w3.doorwarp.getImage(), w3.x2, w3.y2, 28, 29, this); 
        }
        if(MW1.count == 1){ 
            if(MW1.alive == true){
               g.drawImage(MW1.MonsterW.getImage(), MW1.x, MW1.y-10, 75, 80, this); 
            ...
            if(MW1.alive == true){
                g.drawImage(MW1.MonsterW.getImage(), MW1.x, MW1.y, 75, 70, this);
                g.drawString("HPM : "+MW1.hp, MW1.x-10, MW1.y-15);
            }
        ...
        if(MW2.count == 1){ 
            if(MW2.alive == true){
               g.drawImage(MW2.MonsterW.getImage(), MW2.x, MW2.y-10, 75, 80, this); 
            ...
            if(MW2.alive == true)
            g.drawImage(MW2.MonsterW.getImage(), MW2.x, MW2.y, 75, 70, this);
            g.drawString("HPM : "+MW2.hp, MW2.x-10, MW2.y-15);           
        }
        if(hit1==true){
            hc.hp-=MW1.damage;
        ...
        if(nextstage == true){
            ...
            g.drawImage(win.getImage(), 0, 0, 1200, 665, this);
            hc.x = xx;
            hc.y = yy;
            hc.hp = hpp;
            hc.floor = floors;
