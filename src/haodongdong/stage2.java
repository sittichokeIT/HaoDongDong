...
public class stage2 extends JPanel implements ActionListener{
    private ImageIcon wallpaper = new ImageIcon(this.getClass().getResource("bg2.png"));
    private ImageIcon wallpapers = new ImageIcon(this.getClass().getResource("bg2_died.gif"));
    private ImageIcon nextstagebutton = new ImageIcon(this.getClass().getResource("nextstage.png"));
    private ImageIcon success = new ImageIcon(this.getClass().getResource("success.gif"));
    private ImageIcon closebutton = new ImageIcon(this.getClass().getResource("closebt.gif"));
    HaoChar hc = new HaoChar(2);
    ...
    MonsterBone MB1 = new MonsterBone(1);
    MonsterBone MB2 = new MonsterBone(2);
    public int xx = hc.x;
    public int yy = hc.y;
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(stairlong.stairlong.getImage(), stairlong.x, stairlong.y,44 , 410, this); 
        g.drawImage(stair1.stair.getImage(), stair1.x, stair1.y,38 , 200, this);
        g.drawImage(stair2.stair.getImage(), stair2.x, stair2.y,38 , 220, this);
        ...
        if(MB1.count == 1){ 
            if(MB1.alive == true){
               g.drawImage(MB1.MonsterSkat.getImage(), MB1.x, MB1.y-10, 75, 80, this); 
            ...
            if(MB1.alive == true)
            g.drawImage(MB1.MonsterSk.getImage(), MB1.x, MB1.y, 75, 70, this);
            g.drawString("HPM : "+MB1.hp, MB1.x-10, MB1.y-15);
            
        }
        if(MB2.count == 1){ 
            if(MB2.alive == true){
               g.drawImage(MB2.MonsterSkat.getImage(), MB2.x, MB2.y-10, 75, 80, this); 
            ...
            if(MB2.alive == true){
                g.drawImage(MB2.MonsterSk.getImage(), MB2.x, MB2.y, 75, 70, this);
                g.drawString("HPM : "+MB2.hp, MB2.x-10, MB2.y-15);
            }
        ...
        if(hc.hp <= 0){
            ...
            g.drawImage(wallpapers.getImage(), 0, 0, 1200, 800, this);   
            setLayout(null);
        ...
        if(nextstage == true){
            ...
            g.drawImage(success.getImage(), 0, 0, 1200, 665, this);
            hc.x = xx;
            hc.y = yy;
            hc.hp = hpp;
            hc.floor = floors;
            hc.door = doors;
            setLayout(null);
            nextstagebt.setBounds(750, 570, 352, 68);
